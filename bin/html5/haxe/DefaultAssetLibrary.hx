...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("assets/skybox/Sky_FantasySky_Fire_Cam_px.jpg", __ASSET__assets_skybox_sky_fantasysky_fire_cam_px_jpg);
		type.set ("assets/skybox/Sky_FantasySky_Fire_Cam_px.jpg", AssetType.IMAGE);
		...
		type.set (id, AssetType.IMAGE);
		id = "assets/skybox/Sky_FantasySky_Fire_Cam_px.jpg";
		path.set (id, id);
...
@:keep @:bind #if display private #end class __ASSET__assets_skybox_sky_fantasysky_fire_cam_px_jpg extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:image("assets/img/flare.png") #if display private #end class __ASSET__assets_img_flare_png extends lime.graphics.Image {}
@:image("assets/img/lens4.png") #if display private #end class __ASSET__assets_img_lens4_png extends lime.graphics.Image {}
@:image("assets/img/lens5.png") #if display private #end class __ASSET__assets_img_lens5_png extends lime.graphics.Image {}
@:image("assets/img/skybox/skybox_nx.jpg") #if display private #end class __ASSET__assets_img_skybox_skybox_nx_jpg extends lime.graphics.Image {}
@:image("assets/img/skybox/skybox_ny.jpg") #if display private #end class __ASSET__assets_img_skybox_skybox_ny_jpg extends lime.graphics.Image {}
@:image("assets/img/skybox/skybox_nz.jpg") #if display private #end class __ASSET__assets_img_skybox_skybox_nz_jpg extends lime.graphics.Image {}
@:image("assets/img/skybox/skybox_px.jpg") #if display private #end class __ASSET__assets_img_skybox_skybox_px_jpg extends lime.graphics.Image {}
@:image("assets/img/skybox/skybox_py.jpg") #if display private #end class __ASSET__assets_img_skybox_skybox_py_jpg extends lime.graphics.Image {}
@:image("assets/img/skybox/skybox_pz.jpg") #if display private #end class __ASSET__assets_img_skybox_skybox_pz_jpg extends lime.graphics.Image {}
@:image("assets/skybox/Sky_FantasySky_Fire_Cam_px.jpg") #if display private #end class __ASSET__assets_skybox_sky_fantasysky_fire_cam_px_jpg extends lime.graphics.Image {}
